subroutine src2(meqn,mbc,mx,my,xlower,ylower,dx,dy,q,maux,aux,t,dt)
    ...
    if (.true.) then
        ...
        area = (x2rs-x1rs)*(y2rs-y1rs) &
                * (DEG2RAD*earth_radius)**2 * cos(DEG2RAD*y1rs)  ! m**2
        discharge_cfs = 10000e0  ! cubic feet per second
        discharge = discharge_cfs *(0.3048)**3  ! m**3 / second
        rs = discharge/area  ! m/sec,  throughout source area
